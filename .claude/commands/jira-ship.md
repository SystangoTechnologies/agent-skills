---
description: Run the pre-launch checklist, prepare for production deployment, and update Jira ticket comments
---

Invoke the `sys:jira-shipping-and-launch` skill.
...
7. **Jira Update** — Post launch readiness/progress comment to the relevant Jira ticket/task
